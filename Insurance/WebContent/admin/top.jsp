...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">平安保险信息管理平台</b> <!-- <img border="0" src="style/images/logo.png" /> -->
        </div>
		<!-- 欢迎用户的文字 -->
		<div id="Head_1_UserWelcome">
			...
			String adminname="";
				if(admin!=null){
					adminname="尊敬的"+admin+"管理员，您好";
				}else{
					adminname="管理员请先登陆再进行操作";
				}
			%>
		...
		<div id="Head_1_FunctionButton">
			...
			<a target="_parent" href="adminExitLogin.jsp">
